...
export class UserController {
  ...
  public async createUser(
    ...
    await this.userService.checkUserTelAndUsernameAndEmail(tel, username, email)
    await this.userService.createUser(createUserDto, RolesEnum.user)
  ...
  public async createAdmin(
    ...
    await this.userService.checkUserTelAndUsernameAndEmail(tel, username, email)
    await this.userService.createUser(createUserDto, RolesEnum.admin)
